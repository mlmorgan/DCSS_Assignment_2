	...
	implements org.omg.CORBA.portable.InvokeHandler, AirMonitoringSystem.RegionalCentreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "add_monitoring_station", Integer.valueOf(2));
		...
		m_opsHash.put ( "_get_List_of_stations", Integer.valueOf(6));
	}
...
_out.write_string( tmpResult10 );
			...
			case 6: // _get_List_of_stations
			{
			_out = handler.createReply();
			AirMonitoringSystem.List_of_serversHelper.write(_out,List_of_stations());
				break;
			}
		}
		return _out;
