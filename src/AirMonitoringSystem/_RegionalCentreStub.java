...
public class _RegionalCentreStub
	...
	implements AirMonitoringSystem.RegionalCentre
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = AirMonitoringSystem.RegionalCentreOperations.class;
...
_os.write_string( tmpResult3 );
		...
		else
		{
			...
			try
			{
				_localServant.add_monitoring_station(station_name);
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					AirMonitoringSystem.NoxReadingHelper.write(_os,alarmReading);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					AirMonitoringSystem.NoxReading[] _result = AirMonitoringSystem.Set_of_readingsHelper.read(_is);
					return _result;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					_is = _invoke(_os);
					return AirMonitoringSystem.Log_of_alarm_readingsHelper.read(_is);
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
					{
						continue;
