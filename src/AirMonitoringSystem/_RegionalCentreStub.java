...
_os.write_string( tmpResult7 );
					java.lang.String tmpResult8 = station_ior;
_os.write_string( tmpResult8 );
		...
		else
		{
			...
			try
			{
				_localServant.add_monitoring_station(name,location,station_ior);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public AirMonitoringSystem.ServerRef[] List_of_stations()
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request("_get_List_of_stations",true);
					_is = _invoke(_os);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "_get_List_of_stations", _opsClass);
				if( _so == null )
					continue;
				RegionalCentreOperations _localServant = (RegionalCentreOperations)_so.servant;
				...
				try
				{
					_result = _localServant.List_of_stations();
					if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
						((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
						return _result;
				}
