	...
	implements org.omg.CORBA.portable.InvokeHandler, AirMonitoringSystem.MonitoringCentreOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_List_of_centres", Integer.valueOf(2));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // register_regional_centre
			{
				...
				_out = handler.createReply();
				register_regional_centre(_arg0,_arg1,_arg2);
				break;
			}
			case 2: // _get_List_of_centres
			{
			_out = handler.createReply();
			AirMonitoringSystem.List_of_serversHelper.write(_out,List_of_centres());
				break;
			}
