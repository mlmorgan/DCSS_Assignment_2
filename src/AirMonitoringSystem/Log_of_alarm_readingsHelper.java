...
public abstract class Log_of_alarm_readingsHelper
{
	...
	{
		return "IDL:AirMonitoringSystem/Log_of_alarm_readings:1.0";
	}
	public static AirMonitoringSystem.NoxReading[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new AirMonitoringSystem.NoxReading[_l_result0];
